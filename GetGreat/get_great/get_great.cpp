...
double getGreaterValue(string prompt , double lowerbound)
{
    
    double value;
    cout << prompt << "(must be greater than " << lowerbound <<"): ";
    ...
    do
    {
        ...
        if (value <=lowerbound)
        {
            cout << "Error: the value must be greater than " << lowerbound <<". Try again: ";
        }
