...
void highestValue(float arr1[], float arr2[], float arr3[], int size) {
    ...
    // Display the highest values from each array
    cout << "high in 1st array == " << fixed << setprecision(1) << max1 << endl;
    cout << "high in 2nd array == " << fixed << setprecision(1) << max2 << endl;
    cout << "high in 3rd array == " << fixed << setprecision(1) << max3 << endl;
}
