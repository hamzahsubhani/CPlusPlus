...
double getLesserValue(string prompt, double upperBound)
{
    double value;
    cout << prompt << " (must be less than " << upperBound << "): ";
    cin >> value;
    do {
        
        if (value >= upperBound)
        {
            cout << "Error: the value must be less than " << upperBound << ". Try again: ";
            cin >> value;
        }
