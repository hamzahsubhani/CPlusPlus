...
void PiggyBank :: printBankValue()
{
    ...
    cout << fixed << setprecision (2) << "$" <<calcBankValue();
...
void  PiggyBank :: addCoins( int morePennies, int moreNickels, int moreDimes, int moreQuarters )
{
    ...
    if ( morePennies < 0 )
    {
        cout << "Error: Cannot add a negative amount of Pennies" << endl;
    }
    else
    {
    ...
    if ( moreDimes < 0 )
    {
        cout << "Error: Cannot add a negative amount of Dimes" << endl;
    }
    else
    {
    ...
    if ( moreQuarters < 0 )
    {
        cout << "Error: Cannot add a negative amount of Quarters" << endl;    }
    else
    {
    ...
    if ( moreNickels < 0 )
    {
        cout << "Error: Cannot add a negative amount of Nickels" << endl;
    }
    else
    {
...
{
    double value = (numPennies * .01) + (numNickels * .05) + (numDimes * .10) +  + (numQuarters * .25);
    
    return value;
}

/***************************************************************
Function: addPennies, addDimes, addQuarters, addNickels
...
void PiggyBank :: addPennies( int morePennies )
{
    ...
    if ( morePennies < 0 )
    {
        cout <<"Error: Cannot add a negative amount of pennies" << endl << endl;
    }
    else
    {
...
{
    numPennies  = numDimes = numNickels = numQuarters = 0;
}
