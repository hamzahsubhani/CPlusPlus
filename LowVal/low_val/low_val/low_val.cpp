...
{
    float lowest1=arr1[0], lowest2=arr2[0], lowest3=arr3[0];
    ...
    cout <<"low in 1st array == "<< lowest1 << endl;
    cout <<"low in 2nd array == "<< lowest2 << endl;
    cout <<"low in 3rd array == "<< lowest3 << endl;
    cout << endl;
    
    if (lowest1 < lowest2 && lowest1 < lowest3)
    {
        cout <<"lowest value==" << lowest1 << endl;
    }
    
    if (lowest2 < lowest1 && lowest2 < lowest3)
    {
        cout <<"lowest value==" << lowest2 << endl;
    }
    if (lowest3 < lowest1 && lowest3 < lowest2)
    {
        cout <<"lowest value==" << lowest3 << endl;
    }
    if (lowest1 < lowest2 && lowest1 == lowest3)
    {
        cout <<"lowest value==" << lowest3 << endl;
